...
const Hero = () => {
    return (
         ...
         <div className='max-w-7xl mx-auto lg:pt-20 pt-5 '>
                ...
                <p className='lg:px-50 px-6 text-[#627382] text-[16px] text-center'>AtHERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting.Our goal is to turn your ideas into digital experiences that truly make an impact.</p>
